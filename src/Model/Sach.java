...
public class Sach {
    ...
    // Constructor
    public Sach(int maSach, String tieuDe, int maTacGia, int maNhaXuatBan, int maTheLoai, String maSoSachChuanQuocTe, int namXuatBan, int soTrang, String ngonNgu, int soLuongBanSaoCoSan) {
        this.maSach = maSach;
        this.tieuDe = tieuDe;
